...
class CategoryViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        categoryManager.getCategorysFromRealm().count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = categoryManager.getCategorysFromRealm()[indexPath.row].name
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        toDoListVC.selectedCategory = categoryManager.getCategorysFromRealm()[indexPath.row]
    }
    ...
    @IBAction func addButtonTapped(_ sender: UIBarButtonItem) {
        ...
        alert.addAction(UIAlertAction(title: "확인", style: .default, handler: { okAction in
            ...
            self.categoryManager.saveCategoryInRealm(name: text) {
